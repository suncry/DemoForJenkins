...
struct Protocol_Message_Types_Json: SwiftProtobuf.Message {
...
extension Protocol_Message_Types_Json: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "content"),
    2: .same(proto: "type"),
  ]

  func _protobuf_generated_isEqualTo(other: Protocol_Message_Types_Json) -> Bool {
